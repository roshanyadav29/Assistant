...
# Function to run the Alexa assistant
def run_alexa():
    ...
    try:
        ...
        if 'hello' in command:
            ...
            open different websites like instagram, youtube, gmail, github, stack overflow and search on google. How may i help you ??''')
...
# Run the assistant indefinitely
while True:
    run_alexa()
